                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                        ...
                        gradient: LinearGradient(
                            colors: const [Palette.green, Palette.blue],
              ...
              child: StickyHeader(
                  ...
                  content: Column(
                    children: [
                                        ...
                                        children: [
                                          ...
                                          InkWell(
                                            ...
                                            child: AnimatedContainer(
                                              ...
                                              width: 320,
                                              decoration: BoxDecoration(
                                                  color: _isHoveringMain ? Palette.blue : null,
                                                  borderRadius: BorderRadius.circular(12),
                                                  gradient: _isHoveringMain
                                                      ? null
                      ...
                      Center(
                        ...
                        children: {
                          0: Padding(
                            ...
                            child: bodyText(
                                text: 'Arbeitnehmer',
                                color: _selectedSegment == 0 ? Palette.fadeGreen : Palette.green,
                                bold: true),
                          ),
                          1: Padding(
                            padding: const EdgeInsets.symmetric(horizontal: 15, vertical: 12),
                            child: bodyText(
                                text: 'Arbeitgeber',
                                color: _selectedSegment == 1 ? Palette.fadeGreen : Palette.green,
                                bold: true),
                          ),
                          2: Padding(
                            padding: const EdgeInsets.symmetric(horizontal: 15, vertical: 12),
                            child: bodyText(
                                text: 'Temporärbüro',
                                color: _selectedSegment == 2 ? Palette.fadeGreen : Palette.green,
                                bold: true),
                          )
                        },
                      ...
                      // segment heading
                      Container(
                        margin: EdgeInsets.symmetric(vertical: isMobile ? 30 : 50, horizontal: isMobile ? 20 : 0),
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      ArrowElement(
                                          ...
                                          show: true,
                                          color: Colors.black,
                                          child: bodyText(text: '2.', fontSize: 130)),
                                      const SizedBox(
                                        width: 20,
                                      ),
                                      Column(
